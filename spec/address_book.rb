...
RSpec.describe AddressBook do
  ...
  describe "import from entries_2.csv" do
    ...
    it "imports the 1st entry" do
      book.import_from_csv('entries_2.csv')
      entry_one = book.entries[0]
      check_entry(entry_one, "Dave", "555-555-5555", "dave@hidave.com")
    end

    it "imports the 2nd entry" do
      book.import_from_csv("entries_2.csv")
      entry_two = book.entries[1]
      check_entry(entry_two, "Mickey", "555-555-0000", "mickey@mouse.com")
    ...
    it "imports the 3rd entry" do
      book.import_from_csv("entries_2.csv")
      entry_three = book.entries[2]
      check_entry(entry_three, "Theo", "555-555-1234", "theo@meowmeow.com")
    end
  end
  ...
  describe "#binary_search" do
    ...
    it "searches AddressBook for Billo" do
      book.import_from_csv("entries.csv")
      entry = book.binary_search("Billo")
      expect(entry).to be_nil
    end
  end
  ...
  describe "#iterative_search" do
    ...
    it "searches AddressBook for Billo" do
      book.import_from_csv("entries.csv")
      entry = book.iterative_search("Billo")
      expect(entry).to be_nil
    end
  end
